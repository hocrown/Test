...
if(nowPageBlock>1) {
	out.print("<li>");
	out.print("<a href=\"" + contextPath + "/board/search/" + menuId + "/" + (startPage-1) + "?keyword=" + keyword + "\" aria-label=\"Previous\">");
	out.print("◀</a>");
	out.println("</li>");
}
for(int i=startPage; i<=endPage; i++) {
	...
	out.print("<a href=\"" + contextPath + "/board/search/" + menuId + "/"+ (i) + "?keyword=" + keyword  + "\">");
	out.print(i);
	out.print("</a>");		
	out.println("</li>");
} 
if(nowPageBlock<totalPageBlock) {
	out.print("<li>");
	out.print("<a href=\"" + contextPath + "/board/search/" + menuId + "/"+ (endPage+1) + "?keyword=" + keyword  + "\" aria-label=\"Next\">");
	out.print("▶</a>");
	out.println("</li>");
}
out.println("</ul>");
