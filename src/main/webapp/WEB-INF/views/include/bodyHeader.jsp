...
<%@page import="com.mpc.board.service.BoardMenuService"%>
<%@page import="java.util.List"%>
<%@page import="com.mpc.board.model.MenuModel"%>
<%@page import="com.mpc.board.service.IBoardMenuService"%>
            ...
            <ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                    	<li><a href="<c:url value='/board/menu/1'/>">게시판</a>
			        	<li><a href="<c:url value='/board/menu/2'/>">자료실</a>
			        	<li><a href="<c:url value='/board/menu/3'/>">겔러리</a>
					</ul>
				</li>
                <li class="dropdown">
