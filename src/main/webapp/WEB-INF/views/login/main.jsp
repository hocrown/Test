...
<c:if test="${empty sessionScope.userId}">
    ...
    <div class="form-floating">
      <input type="text" class="form-control" name="userId" id="userId" placeholder="<fmt:message key="MEMBER_ID"/>">
      <label for="floatingInput"><fmt:message key="MEMBER_ID"/>User Id</label>
    </div>

    <div class="form-floating">
      <input type="password" class="form-control" name="userPw" id="userPw" placeholder="<fmt:message key="MEMBER_PW"/>">
