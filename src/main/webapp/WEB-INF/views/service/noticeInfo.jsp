			...
			<div class="colmenu">
	     	<div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
			       <div class="col p-4 d-flex flex-column position-static">
			       	...
			       	<div class="mb-1 text-muted">제목: 들어가는곳</div> 
			       	<div class="mb-1 text-muted">작성자:</div> 
			        <div class="mb-1 text-muted">작성일:YYYY-MM-DD</div> 
			       	 <p class="card-text mb-auto">content들어가는곳</p>
				...
				<div class="screen2-1"> 
					<div> 
						<button type="button" class="btn-admin" onClick="location.href='/service/notice'">공지사항목록</button>
